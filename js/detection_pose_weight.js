...
import {
    ...
    POSE_WEIGHT_FOR_EXERCISE_2, POSE_WEIGHT_FOR_EXERCISE_arm_l, POSE_WEIGHT_FOR_EXERCISE_arm_r,
    POSE_WEIGHT_FOR_EXERCISE_knee, POSE_WEIGHT_FOR_EXERCISE_knee2, SCORE_ARRAY_ARM_2,
    STATE
} from './params.js';
...
// set pose weight
let POSE_WEIGHT = POSE_WEIGHT_FOR_EXERCISE_arm_r;

// set score threshold array
let SCORE_THRESHOLD = SCORE_ARRAY_ARM_2;
...
// weight option for distance
// 90, 80, 70 -> avg : 80
// 0.2 0.4 0.4
// weigted average  : 18 + 32 + 28 = 78
